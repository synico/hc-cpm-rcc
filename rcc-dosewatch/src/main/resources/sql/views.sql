...
create or replace view public.v_exam as
    ...
    pebp.body_category as pre_exam_body_category,
    his.pre_exam_method,
    ris.requisition_id,
    ris.exam_date,
    ...
    from his_exam his full join ris_exam ris on his.sheetid=ris.sheetid
    join body_part_mapping ebp on ris.exam_body_part=ebp.body_part
    join body_part_mapping pebp on his.pre_exam_body_part=pebp.body_part